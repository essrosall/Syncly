...
const Button = React.forwardRef(({
  ...
  const variants = {
    primary: 'bg-neutral-100 hover:bg-neutral-200 text-neutral-900 border border-neutral-200 shadow-sm dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-100 dark:border-neutral-700',

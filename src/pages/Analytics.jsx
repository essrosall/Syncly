        ...
        <div className="grid gap-4 xl:grid-cols-[1.45fr_0.95fr]">
          ...
          <div className="space-y-4">
              ...
              <ul className="mt-5 space-y-3 text-sm text-neutral-700">
                  <li className="flex items-center justify-between rounded-md bg-neutral-100 px-4 py-3">
            ...
            <Card className="rounded-md border-neutral-200 bg-white p-6 shadow-[0_12px_30px_rgba(17,25,43,0.04)]">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-semibold text-neutral-950">Trend Notes</h2>
                  <p className="mt-1 text-sm text-neutral-500">Observations from this period</p>
                </div>
